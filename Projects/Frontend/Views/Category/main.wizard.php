    ...
    <div class="card collapsed-card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h3 class="card-title font-weight-bold">
                    <img src="{{URL::base(FILES_DIR.'/Categories/mcdonalds.jpg')}}" alt="" style="width:25px;height:25px;">
                        MC Donalds
                    </h3>
                </div>  
                <div class="col-md-1 card-tools">
    ...
    <div class="card collapsed-card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h3 class="card-title font-weight-bold">
                    <img src="{{URL::base(FILES_DIR.'/Categories/wolt.png')}}" alt="" style="width:25px;height:25px;">
                        Wolt
                    </h3>
                </div>  
                <div class="col-md-1 card-tools">
